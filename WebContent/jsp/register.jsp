			...
			if (val.length > 0) {
				...
				$.post(url, params, function(data) {
					if (data == 0) {
						...
						$("#span1").html("用户名已被注册").css("color","red");
					}
				});
			}
		});
...
<div class="row"> 
	...
	<div class="col-md-8" style="background:#fff;padding:40px 80px;margin:30px;border:7px solid #ccc;">
		...
		<form class="form-horizontal" style="margin-top:5px;" action="${pageContext.request.contextPath}/RegistServlet?method=registUser" method="post">
